<h1 class="add_gruz_main_heading">Добавить Груз</h1>
    <form method="POST" action="{{ route('addgruz') }}">
        @csrf

        <div class="form-group row add_gruz_wrapper">
            ...
            <div class="col-md-6">
                <label class="country-align" for="country_to">Куда</label>
            ...
            <h3 class="add_gruz_heading">Груз</h3>

            <div class="gruz-fields">
                <div>
                    <div class="col-md-6">
                        <label for="name">Наименование</label>
                        <input class="add_gruz_input" placeholder="наименование" id="name" type="text" class="form-control
                    ...
                    <div class="col-md-6 add-inputs"  >
                        <label for="length">Габариты от:</label>
                ...
                <div>
                    <div class="col-md-6">
                        ...
                        <input class="add_gruz_input" placeholder="масса(т)" id="weight" type="text" class="form-control
                    ...
                    <div class="col-md-6">
                        <label class="adr-label" for="adr">ADR</label>
